<template>
  <footer class="bg-white">
    <div class="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8 border-t border-gray-900/10">
      ...
      <p class="mt-10 text-center text-xs leading-5 text-gray-500">&copy; 2023 Your Twitter, Inc. All rights reserved.</p>
    </div>
  </footer>
</template>

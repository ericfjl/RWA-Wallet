...
<template>
  <div class="flex font-sans top-0 right-0 leading-1em z-999 fixed items-end select-none">
    <div
      ...
      class="bg-black rounded-lg h-min shadow w-max text-gray-800 relative"
      p="x-4 y-2"
      m="y-auto r-2"
    ...
    >
      <button
        type="button"
        class="rounded-full bg-indigo-600 shadow-sm text-white p-2 -left-10 absolute hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
        @click="doClose"
      >

...
const currentStep = $ref('Tier Setup')
const steps = ['NFT Meta', 'Tier Setup', 'Social Links']
...
<template>
  <main>
    ...
    <div main max-w-4xl text-white text-sm>
      ...
      <template v-if="currentStep === 'NFT Meta'">
        ...
        <BsAlertError v-if="error" my-5>
          {{ error.message }}
        </BsAlertError> hello, what's your name?
        <div class="flex mt-6 gap-x-6 items-center justify-end">
          <BsBtnIndigo @click="currentStep = 'Tier Setup'"> Next </BsBtnIndigo>
        </div>
      </template>
      <template v-if="currentStep === 'Tier Setup'">
        ...
        <div class="flex mt-6 gap-x-6 items-center justify-end">
          <button type="button" class="font-semibold leading-6" @click="currentStep = 'NFT Meta'">Previous</button>
          <BsBtnIndigo :is-loading="isLoading" @click="currentStep = 'Social Links'"> Next </BsBtnIndigo>
        </div>
      </template>
      <template v-if="currentStep === 'Social Links'">
        <div class="space-y-12">
          <div class="border-b border-white/10 pb-12">
            <h2 class="font-semibold text-base leading-7">Social Links</h2>
            <p class="mt-1 text-gray-400 leading-6">This information will be publish in the RWA Protocol</p>
